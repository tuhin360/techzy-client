...
import { ShoppingBag, Clock, Zap, Gift, Sparkles, Star, ArrowRight } from "lucide-react";
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-start order-2 lg:order-1">
            <div className="relative group">
              ...
              <img
                ...
                onError={(e) => {
                  e.target.src = "https://via.placeholder.com/300x300/3b82f6/ffffff?text=Smart+Speaker";
                }}
              />
          ...
          <div className="text-center order-1 lg:order-2">
            ...
            {/* Elegant Countdown */}
            <div className="mb-10">
              <p className="text-white/90 font-semibold mb-4 text-lg">Deal Ends In:</p>
              <div className="flex justify-center space-x-3 md:space-x-6">
                {[
                  ...
                  { label: "MINS", value: timeLeft.minutes, color: "from-orange-500 to-red-500" },
                  { label: "SECS", value: timeLeft.seconds, color: "from-green-500 to-emerald-500" }
                ].map((item, index) => (
                  <div key={index} className="relative group">
                    <div className={`bg-gradient-to-br ${item.color} p-4 md:p-6 rounded-2xl shadow-2xl min-w-[70px] md:min-w-[90px] group-hover:scale-110 transition-transform duration-300`}>
                    ...
                    <div className={`absolute inset-0 bg-gradient-to-br ${item.color} rounded-2xl blur-lg opacity-50 group-hover:opacity-70 transition-opacity duration-300`}></div>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="flex justify-center lg:justify-end order-3">
            <div className="relative group">
              ...
              <img
                ...
                className="relative w-56 h-56 md:w-72 md:h-72 object-contain drop-shadow-2xl group-hover:scale-110 group-hover:-rotate-2 transition-all duration-500"
                onError={(e) => {
                  e.target.src = "https://via.placeholder.com/300x300/8b5cf6/ffffff?text=Headphones";
                }}
              />
