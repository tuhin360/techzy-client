                                ...
                                <tr key={user._id} className="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center space-x-3">
                                            <img
                                                // src={user.photoURL || user.image || `https://ui-avatars.com/api/?name=${encodeURIComponent(user.name || user.displayName || 'User')}&background=f97316&color=ffffff`}
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center justify-center space-x-2">
                                            {user.role !== 'admin' && (
                                                <button
                                                    // onClick={() => handleMakeAdmin(user._id, user.name || user.displayName)}
                                            ...
                                            <button
                                                // onClick={() => handleDeleteUser(user._id, user.name || user.displayName)}
