...
const Contact = () => {
  ...
  const position = [23.789346610690792, 90.37316014304601]; // Iqbal Road, West Shewrapara, Mirpur, Dhaka

  // Validation functions
  const validateEmail = (email) =>
    /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email.trim());
  const validatePhone = (phone) => /^[\d\s+()-]{11,}$/.test(phone.trim());
    ...
    switch (name) {
      ...
      case "phone":
        ...
        if (!validatePhone(value))
          return "Please enter a valid phone number (at least 11 digits)";
        break;
      case "message":
  ...
  // Handle blur (validation on leave)
  const handleBlur = (e) => {
    const { name, value } = e.target;
              ...
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-orange-100">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+880 1300-130885</p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Iqbal Road, West Shewrapara, Mirpur
                    </p>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                className={`w-full bg-gradient-to-r from-orange-600 to-yellow-500 text-white py-3 px-6 rounded-lg font-semibold flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transition-all duration-200 ${
                  isSending || !isFormValid
                    ? "opacity-50 cursor-not-allowed"
                    : "hover:from-orange-700 hover:to-yellow-600"
                }`}
              >
            ...
            <div className="h-64 w-full">
              ...
              >
                ...
                <Marker position={position}>
                  <Popup>
                    Our Office <br /> Iqbal Road, West Shewrapara, Mirpur, Dhaka
                  </Popup>
                </Marker>
              </MapContainer>
            </div>
