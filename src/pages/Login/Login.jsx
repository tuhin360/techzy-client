            ...
            <div className="relative z-10 text-center">
              <div className="mb-8">
                <div className="w-64 h-64 mx-auto relative">
                  ...
                  <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-lg animate-bounce" style={{animationDelay: '0.5s'}}>
            ...
            <div className="w-full max-w-md mx-auto">
              ...
              <div className="text-center">
                <p className="text-gray-600">
                  ...
                  <a href="/register" className="text-yellow-600 hover:text-yellow-700 font-semibold hover:underline">
                    Sign up here
                  </a>
                </p>
              </div>
